    ...
    const VmId vmId)
{
    return base64Encode(toString(
        ...
        "sudo docker run -e VMS_AGENT_SERVER_ADDRESS=", vmsAddress,
        "-e VMS_AGENT_VM_ID=", vmId,
        "-e VMS_AGENT_AWS_ACCESS_KEY_ID=", creds.accessKeyId,
        "-e VMS_AGENT_AWS_SECRET_ACCESS_KEY=", creds.secretKey,
        "-e VMS_AGENT_AWS_REGION=us-east-2",
        "-e VMS_AGENT_AWS_BUCKET=vms-job-results",
